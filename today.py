...
def svg_overwrite(
    ...
    tspan[81].firstChild.data = commit_data
    tspan[83].firstChild.data = star_data
    tspan[85].firstChild.data = follower_data
    tspan[87].firstChild.data = loc_data[2]
    tspan[88].firstChild.data = loc_data[0] + "++"
    tspan[89].firstChild.data = loc_data[1] + "--"
